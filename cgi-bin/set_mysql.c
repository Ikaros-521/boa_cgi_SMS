...
int cgiMain(void) 
{
	...
	{	
		ret = system("systemctl start mysqld");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl stop mysqld");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl restart mysqld");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl enable mysqld");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl disable mysqld");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
