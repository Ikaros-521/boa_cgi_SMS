...
int cgiMain(void) 
{
	...
	{	
		ret = system("systemctl start httpd.service");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl stop httpd.service");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl restart httpd.service");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl enable httpd.service");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl disable httpd.service");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
