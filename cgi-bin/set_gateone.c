...
int cgiMain(void) 
{
	...
	{	
		ret = system("systemctl start gateone");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl stop gateone");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl restart gateone");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl enable gateone");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl disable gateone");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
