...
int cgiMain(void) 
{
	...
	{	
		ret = system("systemctl start squid.service");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl stop squid.service");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl restart squid.service");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl enable squid.service");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
	...
	{	
		ret = system("systemctl disable squid.service");
        if(ret == 0)
        {
            printf("<p>success</p>");
        }
